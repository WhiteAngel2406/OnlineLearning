...
public class AdminController {
    ...
    public String adminDashboard(Model model, Authentication authentication) {
        ...
        stats.put("pendingCourses", courseService.countByStatus(Course.CourseStatus.PENDING));
        stats.put("publishedCourses", courseService.countByStatus(Course.CourseStatus.PUBLISHED));
        stats.put("draftCourses", courseService.countByStatus(Course.CourseStatus.DRAFT));

...
import com.swp391.OnlineLearning.Model.enums.*;
import com.swp391.OnlineLearning.repository.*;
    ...
    public void run(String... args) {
        ...
        if (courseRepository.count() == 0) {
            ...
            if (expert != null) {
                ...
                course1.setShortDescription("Khóa học Anh Văn cơ bản dành cho người mới bắt đầu học tiếng Anh");
                course1.setDescription("Khóa học Anh Văn cơ bản dành cho người mới bắt đầu");
                course1.setPrerequisite("Không yêu cầu kiến thức tiền đề");
                course1.setThumbnail("https://example.com/course1.jpg");
                course1.setPrice(990000.0);
                course1.setDiscount(0.0);
                ...
                course2.setShortDescription("Khóa học luyện thi IELTS đạt 7.0 điểm");
                course2.setDescription("Khóa học luyện thi IELTS đạt 7.0 điểm");
                course2.setPrerequisite("Có kiến thức tiếng Anh cơ bản");
                course2.setThumbnail("https://example.com/course2.jpg");
                course2.setPrice(2500000.0);
                course2.setDiscount(10.0);
                ...
                course3.setShortDescription("Cải thiện kỹ năng giao tiếp tiếng Anh");
                course3.setDescription("Cải thiện kỹ năng giao tiếp tiếng Anh");
                course3.setPrerequisite("Có kiến thức tiếng Anh mức trung bình");
                course3.setThumbnail("https://example.com/course3.jpg");
                course3.setPrice(1500000.0);
                course3.setDiscount(0.0);
                ...
                course4.setShortDescription("Tiếng Anh thương mại cho doanh nhân");
                course4.setDescription("Tiếng Anh thương mại cho doanh nhân");
                course4.setPrerequisite("Có kiến thức tiếng Anh giao tiếp");
                course4.setThumbnail("https://example.com/course4.jpg");
                course4.setPrice(3500000.0);
                course4.setDiscount(5.0);
                course4.setCategory(cat1);
                course4.setAuthor(expert);
                course4.setStatus(Course.CourseStatus.DRAFT);
